...
gt_obj_st * gt_init_input(void)
{
	...
	/** lab5 */
	lab5 = gt_label_create(input);
	gt_obj_set_pos(lab5, 15, 179);
	gt_obj_set_size(lab5, 139, 40);
	gt_label_set_font_color(lab5, gt_color_hex(0x0080ff));
