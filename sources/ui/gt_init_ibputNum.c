...
static void ibputNum_0_cb(gt_event_st * e) {
...
{
	ibputNum = gt_obj_create(NULL);

	gt_screen_set_bgcolor(ibputNum, gt_color_hex(0xFFFFFF));


	

	/** lab1 */
	lab1 = gt_label_create(ibputNum);
	...
	/** lab4 */
	lab4 = gt_label_create(ibputNum);
	gt_obj_set_pos(lab4, 15, 138);
	gt_obj_set_size(lab4, 139, 40);
	gt_label_set_font_color(lab4, gt_color_hex(0x808080));
	...
	gt_obj_add_event_cb(lab4, lab4_0_cb, GT_EVENT_TYPE_INPUT_RELEASED, NULL);
	

	/** lab5 */
	lab5 = gt_label_create(ibputNum);
	...
	/** lab10 */
	lab10 = gt_label_create(ibputNum);
	gt_obj_set_pos(lab10, 15, 393);
	gt_obj_set_size(lab10, 159, 40);
	gt_label_set_font_color(lab10, gt_color_hex(0x0080ff));
	...
	/** lab11 */
	lab11 = gt_label_create(ibputNum);
	...
	/** lab12 */
	lab12 = gt_label_create(ibputNum);
	...
	/** lab13 */
	lab13 = gt_label_create(ibputNum);
	...
	/** lab14 */
	lab14 = gt_label_create(ibputNum);
	...
	/** lab15 */
	lab15 = gt_label_create(ibputNum);
	...
	/** lab16 */
	lab16 = gt_label_create(ibputNum);
	...
	/** lab17 */
	lab17 = gt_label_create(ibputNum);
	...
	/** lab18 */
	lab18 = gt_label_create(ibputNum);
	...
	/** lab19 */
	lab19 = gt_label_create(ibputNum);
	...
	/** lab20 */
	lab20 = gt_label_create(ibputNum);
	...
	/** lab21 */
	lab21 = gt_label_create(ibputNum);
	...
	/** lab22 */
	lab22 = gt_label_create(ibputNum);
	...
	/** lab23 */
	lab23 = gt_label_create(ibputNum);
	...
	/** lab24 */
	lab24 = gt_label_create(ibputNum);
	...
	/** lab25 */
	lab25 = gt_label_create(ibputNum);
	...
	/** lab26 */
	lab26 = gt_label_create(ibputNum);
	...
	/** lab27 */
	lab27 = gt_label_create(ibputNum);
	...
	/** lab29 */
	lab29 = gt_label_create(ibputNum);
	...
	/** lab28 */
	lab28 = gt_label_create(ibputNum);
	...
	/** lab31 */
	lab31 = gt_label_create(ibputNum);
	...
	gt_label_set_text(lab31, "计数器控件");
	gt_label_set_space(lab31, 0, 0);

	

	/** rect4 */
	rect4 = gt_rect_create(ibputNum);
	...
	/** inputNum1 */
	inputNum1 = gt_input_number_create(ibputNum);
	gt_obj_set_pos(inputNum1, 305, 100);
	gt_obj_set_size(inputNum1, 92, 44);
	...
	gt_input_number_set_value(inputNum1, 0000);
