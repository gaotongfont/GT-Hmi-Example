...
gt_obj_st * gt_init_switch10(void)
{
	...
	/** lab8 */
	lab8 = gt_label_create(switch10);
	gt_obj_set_pos(lab8, 15, 309);
	gt_obj_set_size(lab8, 159, 40);
	gt_label_set_font_color(lab8, gt_color_hex(0x0080ff));
	...
	/** lab10 */
	lab10 = gt_label_create(switch10);
	...
	/** lab11 */
	lab11 = gt_label_create(switch10);
	...
	/** lab12 */
	lab12 = gt_label_create(switch10);
	...
	/** lab13 */
	lab13 = gt_label_create(switch10);
	...
	/** lab14 */
	lab14 = gt_label_create(switch10);
	...
	/** lab15 */
	lab15 = gt_label_create(switch10);
	...
	/** lab16 */
	lab16 = gt_label_create(switch10);
	...
	/** lab17 */
	lab17 = gt_label_create(switch10);
	...
	/** lab18 */
	lab18 = gt_label_create(switch10);
	...
	/** lab19 */
	lab19 = gt_label_create(switch10);
	...
	/** lab20 */
	lab20 = gt_label_create(switch10);
	...
	/** lab21 */
	lab21 = gt_label_create(switch10);
	...
	/** lab22 */
	lab22 = gt_label_create(switch10);
	...
	/** lab23 */
	lab23 = gt_label_create(switch10);
	...
	/** lab24 */
	lab24 = gt_label_create(switch10);
	...
	/** lab25 */
	lab25 = gt_label_create(switch10);
	...
	/** lab26 */
	lab26 = gt_label_create(switch10);
	...
	/** lab27 */
	lab27 = gt_label_create(switch10);
	...
	/** lab29 */
	lab29 = gt_label_create(switch10);
	...
	/** lab28 */
	lab28 = gt_label_create(switch10);
	...
	/** lab31 */
	lab31 = gt_label_create(switch10);
	...
	gt_label_set_text(lab31, "开关控件");
	gt_label_set_space(lab31, 0, 0);

	

	/** rect4 */
	rect4 = gt_rect_create(switch10);
