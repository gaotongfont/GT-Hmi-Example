...
gt_obj_st * gt_init_imgbtn(void)
{
	...
	label_input_title = gt_label_create(imgbtn);
	...
	label_keyboard_title = gt_label_create(imgbtn);
	...
	gt_imgbtn_set_src(imgbtn_Doubleicon, ".:img_sunny_70x70.png");
	gt_imgbtn_set_src_press(imgbtn_Doubleicon, ".:img_sleep5_70x70.png");
	...
	gt_imgbtn_set_src(imgbtn_Threeicons, ".:img_language_54x54.png");
	gt_imgbtn_add_state_item(imgbtn_Threeicons, ".:img_guide_54x54.png");
	gt_imgbtn_add_state_item(imgbtn_Threeicons, ".:img_outdoor_walk_54x54.png");
	gt_imgbtn_add_state_item(imgbtn_Threeicons, ".:img_system_54x54.png");
