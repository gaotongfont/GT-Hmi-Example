...
gt_obj_st * gt_init_imgbtn(void)
{
	...
	/** lab6 */
	lab6 = gt_label_create(imgbtn);
	gt_obj_set_pos(lab6, 15, 222);
	gt_obj_set_size(lab6, 159, 40);
	gt_label_set_font_color(lab6, gt_color_hex(0x0080ff));
	...
	gt_label_set_text(lab31, "图片按钮控件");
	...
	gt_imgbtn_set_src(imgbtn1, ".:img_sunny_100x100.png");
	gt_imgbtn_set_src_press(imgbtn1, ".:img_sleep5_100x100.png");
