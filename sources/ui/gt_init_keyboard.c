...
static gt_obj_st * label_keyboard_category = NULL;
...
gt_obj_st * gt_init_keyboard(void)
{
	...
	gt_screen_set_bgcolor(keyboard, gt_color_hex(0xFFFFFF));
	...
	label_button_title = gt_label_create(keyboard);
	...
	label_image_title = gt_label_create(keyboard);
	...
	label_inputNum_title = gt_label_create(keyboard);
	...
	label_clock_title = gt_label_create(keyboard);
	...
	label_barcode_title = gt_label_create(keyboard);
	...
	label_qrcode_title = gt_label_create(keyboard);
	...
	label_viewPager_title = gt_label_create(keyboard);
	...
	label_diglog_title = gt_label_create(keyboard);
	...
	label_gif_title = gt_label_create(keyboard);
	...
	label_layout_title = gt_label_create(keyboard);
	...
	label_mediaplayer_title = gt_label_create(keyboard);
	...
	label_group_title = gt_label_create(keyboard);
	...
	label_slider_title = gt_label_create(keyboard);
	...
	label_bar_title = gt_label_create(keyboard);
	gt_obj_set_pos(label_bar_title, 15, 854);
	...
	label_radio_title = gt_label_create(keyboard);
	...
	label_checkbox_title = gt_label_create(keyboard);
	...
	label_listv_title = gt_label_create(keyboard);
	...
	label_roller_title = gt_label_create(keyboard);
	...
	label_graph_title = gt_label_create(keyboard);
	...
	label_rect_title = gt_label_create(keyboard);
	...
	label_statusbartitle = gt_label_create(keyboard);
	...
	label_screen_title = gt_label_create(keyboard);
	...
	/** label_keyboard_category */
	/** 键盘控件板块的标题Label */
	label_keyboard_category = gt_label_create(keyboard);
	gt_obj_set_pos(label_keyboard_category, 240, 14);
	gt_obj_set_size(label_keyboard_category, 162, 34);
	gt_label_set_font_color(label_keyboard_category, gt_color_hex(0x0080ff));
	gt_label_set_font_family(label_keyboard_category, gray_black_24);
	gt_label_set_font_cjk(label_keyboard_category, 0);
	gt_label_set_font_align(label_keyboard_category, GT_ALIGN_LEFT_MID);
	gt_label_set_text(label_keyboard_category, "键盘控件");
	gt_label_set_space(label_keyboard_category, 0, 0);

	

	/** rect4 */
	rect4 = gt_rect_create(keyboard);
