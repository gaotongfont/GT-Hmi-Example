...
gt_obj_st * gt_init_label(void)
{
	...
	/** lab3 */
	lab3 = gt_label_create(label);
	gt_obj_set_pos(lab3, 15, 95);
	gt_obj_set_size(lab3, 139, 40);
	gt_label_set_font_color(lab3, gt_color_hex(0x0080ff));
