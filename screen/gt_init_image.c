...
gt_obj_st * gt_init_image(void)
{
	...
	gt_img_set_src(img1, "f:img_bgImg32_313x174.png");
	...
	gt_img_set_src(img2, "f:img_bgImg7_200x200.png");
	...
	gt_img_set_src(img3, "f:img_sleep5_78x78.png");
	...
	gt_img_set_src(img4, "f:img_music14_78x78.png");
	...
	gt_img_set_src(img5, "f:img_sunny_80x80.png");
