...
gt_obj_st * gt_init_image(void)
{
	...
	gt_img_set_src(img_background, "f:img_bgImg32_354x198.png");
	...
	gt_img_set_src(img_circle, "f:img_bgImg7_200x200.png");
	...
	gt_img_set_src(img_sleep, "f:img_sleep5_78x78.png");
	...
	gt_img_set_src(img_music, "f:img_music14_78x78.png");
	...
	gt_img_set_src(img_sunny, "f:img_sunny_80x80.png");
